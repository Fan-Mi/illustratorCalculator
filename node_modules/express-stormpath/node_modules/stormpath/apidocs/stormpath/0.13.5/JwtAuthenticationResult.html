...
<header>
        ...
        JwtAuthenticationResult
            ...
            <div class="class-description">Encapsulates an authentication result that was retrieved by making a POST to
the application's `/oauth/token` endpoint</div>
...
<article>
    ...
    <h4 class="name" id="JwtAuthenticationResult"><span class="type-signature"></span>new JwtAuthenticationResult<span class="signature">(application, data)</span><span class="type-signature"></span></h4>
...
<span class="param-type">object</span>
            ...
            <td class="description last">The Stormpath application that issued the response.</td>
        </tr>
...
<span class="param-type">object</span>
            ...
            <td class="description last">The response from the Stormpath application.</td>
        </tr>
...
<dl class="details">
    ...
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="jwt_jwt-authentication-result.js.html">jwt/jwt-authentication-result.js</a>, <a href="jwt_jwt-authentication-result.js.html#line13">line 13</a>
    </li></ul></dd>
